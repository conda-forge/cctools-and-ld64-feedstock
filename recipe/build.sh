...
if [[ $target_platform == osx-* ]]; then
  ...
  export CC="${BUILD_PREFIX}/bin/clang-${CLANG_EXE_VERSION} --target=${CONDA_TOOLCHAIN_HOST}"
  export CXX="${BUILD_PREFIX}/bin/clang++-${CLANG_EXE_VERSION} --target=${CONDA_TOOLCHAIN_HOST}"
